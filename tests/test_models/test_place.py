#!/usr/bin/python3
"""
Contains the TestPlaceDocs and TestPlace classes for testing the Place class.
"""
...
Place = place.Place  # Importing Place class
...
class TestPlaceDocs(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.place_f = inspect.getmembers(Place, inspect.isfunction)  # Get all functions of Place

    def test_pep8_conformance_place(self):
        """Test that models/place.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(['models/place.py'])  # Check PEP8 compliance
    ...
    def test_pep8_conformance_test_place(self):
        ...
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(['tests/test_models/test_place.py'])  # Check PEP8 compliance
        self.assertEqual(result.total_errors, 0,
                         "Found code style errors (and warnings).")
    ...
    def test_place_module_docstring(self):
        ...
        self.assertIsNot(place.__doc__, None,
                         "place.py needs a docstring")  # Check if module has docstring
    ...
    def test_place_class_docstring(self):
        ...
        self.assertIsNot(Place.__doc__, None,
                         "Place class needs a docstring")  # Check if class has docstring
        self.assertTrue(len(Place.__doc__) >= 1,
