...
class TestBaseModelDocs(unittest.TestCase):
    ...
    def test_func_docstrings(self):
        ...
        for func_name, func in base_funcs:
            with self.subTest(function=func_name):
                self.assertIsNot(func.__doc__, None, "{:s} method needs a docstring".format(func_name))
                self.assertTrue(len(func.__doc__) > 1, "{:s} method needs a docstring".format(func_name))
