#!/usr/bin/python3
"""
Contains the classes TestDBStorageDocs and TestDBStorage
"""
...
test_db_storage.py'])
    ...
    def test_dbs_func_docstrings(self):
        ...
        for name, func in inspect.getmembers(DBStorage, inspect.ismethod):
            self.assertIsNot(func.__doc__, None,
                             "{} method needs a docstring".format(name))
