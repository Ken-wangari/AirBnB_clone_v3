#!/usr/bin/python3
"""
Contains the TestReviewDocs and TestReview classes for testing the Review class.
"""
...
Review = review.Review  # Importing Review class
...
class TestReviewDocs(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.review_f = inspect.getmembers(Review, inspect.isfunction)  # Get all functions of Review

    def test_pep8_conformance_review(self):
        """Test that models/review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(['models/review.py'])  # Check PEP8 compliance
    ...
    def test_pep8_conformance_test_review(self):
        ...
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(['tests/test_models/test_review.py'])  # Check PEP8 compliance
        self.assertEqual(result.total_errors, 0,
                         "Found code style errors (and warnings).")
    ...
    def test_review_module_docstring(self):
        ...
        self.assertIsNot(review.__doc__, None,
                         "review.py needs a docstring")  # Check if module has docstring
    ...
    def test_review_class_docstring(self):
        ...
        self.assertIsNot(Review.__doc__, None,
                         "Review class needs a docstring")  # Check if class has docstring
        self.assertTrue(len(Review.__doc__) >= 1,
    ...
    def test_review_func_docstrings(self):
        ...
        for func in self.review_f:
            self.assertIsNot(func[1].__doc__, None,
                             "{:s} method needs a docstring".format(func[0]))  # Check if each method has docstring
